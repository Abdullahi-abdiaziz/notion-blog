...
const PostCard = ({ post }: PostPage) => {
  return (
    <article className="border-[3px] border-gray-200 dark:border-gray-800 mx-auto rounded-md shadow-md w-ful h-[22rem]  lg:h-[24rem] w-[20rem] sm:w-[22rem]  lg:w-[27rem] relative dark:bg-slate-900 hover:scale-105 transition-all duration-200">
      {post.cover && (
